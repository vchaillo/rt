...
/*   Updated: 2017/03/19 16:01:16 by valentin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			load_scene8_objects(t_scene *scene)
{
	...
	add_object(scene, new_object(BOX, new_box(new_vector(-2,-0.7,-1.3), new_vector(-6, -4.6, 4),
		new_vector(0, 0, 0)), new_color(GREEN), new_material(BASIC)));
	add_object(scene, new_object(BOX, new_box(new_vector(-2,-0.7,-1.3), new_vector(-6, -3.2, 1.4),
		new_vector(0, 0, 0)), new_color(GREEN), new_material(BASIC)));
	add_object(scene, new_object(BOX, new_box(new_vector(-2,-0.7,-1.3), new_vector(-6, -1.8, -1.2),
		new_vector(0, 0, 0)), new_color(GREEN), new_material(BASIC)));
	add_object(scene, new_object(BOX, new_box(new_vector(-2,-0.7,-1.3), new_vector(-6, -0.4, -3.8),
		new_vector(0, 0, 0)), new_color(GREEN), new_material(BASIC)));
	add_object(scene, new_object(BOX, new_box(new_vector(-2,-0.7,-1.3), new_vector(-6, 1, -6.4),
		new_vector(0, 0, 0)), new_color(GREEN), new_material(BASIC)));
	add_object(scene, new_object(BOX, new_box(new_vector(-2,-0.7,-1.3), new_vector(-6, 2.4, -9),
		new_vector(0, 0, 0)), new_color(GREEN), new_material(BASIC)));
	add_object(scene, new_object(BOX, new_box(new_vector(-2,-0.7,-1.3), new_vector(-6, 3.8, -11.6),
		new_vector(0, 0, 0)), new_color(GREEN), new_material(BASIC)));
	add_object(scene, new_object(BOX, new_box(new_vector(-2,-0.7,-1.3), new_vector(-6, 5.2, -14.2),
		new_vector(0, 0, 0)), new_color(GREEN), new_material(BASIC)));
