...
/*   Updated: 2017/03/14 06:37:09 by vchaillo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				key_hook_rot_x_camera(int keycode, t_camera *camera)
{
	...
	{
		camera->rot.x += 10;
		camera->dir = vector_rot_x(camera->dir, 10);
		camera->dir_left = vector_rot_x(camera->dir_left, 10);
		camera->dir_up = vector_rot_x(camera->dir_up, 10);
	}
...
int				key_hook_rot_y_camera(int keycode, t_camera *camera)
{
	...
	{
		camera->rot.y += 10;
		camera->dir = vector_rot_y(camera->dir, 10);
		camera->dir_left = vector_rot_y(camera->dir_left, 10);
		camera->dir_up = vector_rot_y(camera->dir_up, 10);
	}
...
int				key_hook_rot_z_camera(int keycode, t_camera *camera)
{
	...
	{
		camera->rot.z += 10;
		camera->dir = vector_rot_z(camera->dir, 10);
		camera->dir_left = vector_rot_z(camera->dir_left, 10);
		camera->dir_up = vector_rot_z(camera->dir_up, 10);
	}
